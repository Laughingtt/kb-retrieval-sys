...
from kb_retrieval.kb.ingest.incremental import delete, hash_store
from kb_retrieval.kb.ingest.wiki.ingest_cache import save_cache
...
def test_purge_deletes_pages_md_cache_hash(tmp_path: Path):
    ...
    # hash 条目被删
    from kb_retrieval.kb.ingest.incremental.hash_store import load_hash
