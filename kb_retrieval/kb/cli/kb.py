...
DEFAULT_RAW = "kb_retrieval/kb/knowledge_base/raw"
DEFAULT_MD = "kb_retrieval/kb/knowledge_base/md"
DEFAULT_WIKI = "kb_retrieval/kb/knowledge_base/wiki"
DEFAULT_CACHE = "kb_retrieval/kb/knowledge_base/.cache/ingest-cache.json"
DEFAULT_HASH = "kb_retrieval/kb/knowledge_base/.cache/hash.json"
DEFAULT_LOG = "kb_retrieval/kb/knowledge_base/ingest_log.jsonl"
...
def clean(path: Path, md_root: Path, raw_root: Path, dry_run: bool) -> None:
    ...
    PATH 是文件时，raw_root 用于相对路径计算（默认 kb_retrieval/kb/knowledge_base/raw）。
    """
